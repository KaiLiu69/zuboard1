...
#
# Script generated by Vivado on Sun Aug 03 15:11:25 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mdesign xil_defaultlib.mdesign xil_defaultlib.glbl -log elaborate.log
}
