...
#
# Script generated by Vivado on Tue Jul 29 20:35:39 +0200 2025
...
#
# Usage        : mdesign.sh
#                mdesign.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mdesign.sh [-reset_run]
#                mdesign.sh [-reset_log]
#                mdesign.sh [-help]
#
...
# script info
echo -e "mdesign.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mdesign.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L proc_sys_reset_v5_0_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mdesign xil_defaultlib.mdesign xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mdesign -key {Behavioral:sim_1:Functional:mdesign} -tclbatch cmd.tcl -protoinst "protoinst_files/mdesign.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mdesign.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mdesign.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mdesign.sh [-help]\n\
Usage: mdesign.sh [-step]\n\
Usage: mdesign.sh [-lib_map_path]\n\
Usage: mdesign.sh [-reset_run]\n\
Usage: mdesign.sh [-reset_log]\n\
Usage: mdesign.sh [-keep_index]\n\
Usage: mdesign.sh [-noclean_files]\n\n\
