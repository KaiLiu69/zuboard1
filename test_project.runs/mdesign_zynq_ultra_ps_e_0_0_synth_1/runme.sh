...
HD_PWD='/home/kai/projects/amd/zuboard/test_project.runs/mdesign_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mdesign_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mdesign_zynq_ultra_ps_e_0_0.tcl
