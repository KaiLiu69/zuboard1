...
HD_PWD='/home/kai/projects/amd/zuboard/test_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mdesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mdesign_wrapper.tcl -notrace
