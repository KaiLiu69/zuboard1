...
HD_PWD='/home/kai/projects/amd/zuboard/test_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mdesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mdesign_wrapper.tcl
