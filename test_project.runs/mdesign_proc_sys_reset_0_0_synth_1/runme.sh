...
HD_PWD='/home/kai/projects/amd/zuboard/test_project.runs/mdesign_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mdesign_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mdesign_proc_sys_reset_0_0.tcl
